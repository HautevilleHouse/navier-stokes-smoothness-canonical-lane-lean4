# Navier Stokes Smoothness — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/navier-stokes-smoothness-canonical-lane-mathlib.git
cd navier-stokes-smoothness-canonical-lane-mathlib
lake exe
lake build
```
